...
class PriceData(BaseModel):
    ...
    high_24h: Optional[float] = Field(None, ge=0)  # Изменено: ge=0 вместо gt=0 (некоторые биржи возвращают 0)
    low_24h: Optional[float] = Field(None, ge=0)   # Изменено: ge=0 вместо gt=0
